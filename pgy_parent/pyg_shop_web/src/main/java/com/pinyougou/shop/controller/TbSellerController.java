...
public class TbSellerController {
    ...
    @RequestMapping("/findSellerAll/{sellerId}")
    public TbSeller getfindSellerAll(@PathVariable("sellerId") String sellerId) {
        return tbSellerService.sellerInitFind(sellerId);
    }
