...
public class SendSmsController {
    ...
    @Value("${accessKeyId}")
    private String accessKeyId = "LTAIJnVhI8TRC2qT";
    @Value("${accessKeySecret}")
    private String accessKeySecret = "i8dam20dAodPRRilIEK5Bh1X4x8bYs";
     ...
     * @param templateParam 几位数的验证码
     * @return
     * @throws Exception
     */
    @RequestMapping(value = "/smsSend",method = RequestMethod.POST)
    public Map getSendSms(String phoneNumbers,String signName,String templateCode,String templateParam) throws Exception {
     ...
     */
    public Map querySendDetails(String phoneNumbers,String bizId) throws ClientException {
