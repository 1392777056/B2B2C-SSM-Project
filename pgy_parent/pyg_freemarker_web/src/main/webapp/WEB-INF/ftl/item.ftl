		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${goods.catMap.category1}</a>
					</li>
					<li>
						<a href="#">${goods.catMap.category2}</a>
					</li>
					<li>
						<a href="#">${goods.catMap.category3}</a>
					</li>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<#if (images?size>0)>
								<span class="jqzoom"><img style="width: 400px;height: 400px;" jqimg="${images[0].url}" src="${images[0].url}" /></span>
							</#if>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						...
						<div id="specification" class="summary-wrap clearfix">
							<dl>
								...
								<dd><a href="javascript:;" ng-click="changeSpec('${spec.attributeName}','${attr}')" class="{{ifSelected('${spec.attributeName}','${attr}')?'selected':''}}">${attr}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
						</div>
						</#list>
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" ng-click="changNum(num+1)" class="increment plus">+</a>
										<a href="javascript:void(0)" ng-click="changNum(num-1)" class="increment mins">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
